...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=1.0\linewidth]{imgs/ER/er-diagram-without.png}
	\caption{数据库E-R图}
...
\begin{enumerate}[label=(\arabic*)]	
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.7\linewidth]{imgs/ER/工时.png}
		\caption{工时数据库关系图}
		\label{fig:er-org-wh}
	\end{figure}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.85\linewidth]{imgs/ER/重大问题.png}
