...
\section{后端技术栈}
\subsection{Spring Boot 框架}
\subsection{MyBatis-Plus 与 MySQL}
\subsection{Apache Shiro 安全框架 与 JWT 认证}
\subsection{Redis 缓存}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.38\textwidth}
    \centering
    \includegraphics[width=0.68\linewidth]{imgs/demo2(a).png}
    \caption*{(a) 速度障碍集合}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.38\textwidth}
    \centering
    \includegraphics[width=0.68\linewidth]{imgs/demo2(b).png}
    \caption*{(b) 避免碰撞集合}
  \end{subfigure}
  \caption{速度障碍法速度选择}
\end{figure}
...
\begin{center}
  ...
  \begin{tabular}{cccc}
    ...
    $5.0 \le x < 10.0$  & 0.10  & \multicolumn{2}{c}{interesting} \\
...
\begin{center}
  \captionof{table}{室外细菌气溶胶香农-维纳指数（H）和均匀性指数（E）}
  {\songti\fontsize{10.5pt}{12.6pt}\selectfont
  \begin{tabular*}{16.48cm}{@{\extracolsep{\fill}}lcccccccccccc}
    \toprule
